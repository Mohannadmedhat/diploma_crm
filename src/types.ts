...
export const DEFAULT_INSTRUCTORS: Instructor[] = [
  ...
  { id: 'inst-5', name: 'Eng. Abdallah Wageh', phone: '+201002143879', email: '', status: 'Active', hourlyRate: 300 },
  { id: 'inst-6', name: 'Eng. Abdelnaby', phone: '', email: '', status: 'Active' },
  { id: 'inst-7', name: 'Eng. Abdelrahman Afefy', phone: '', email: '', status: 'Active' },
  { id: 'inst-8', name: 'Eng. Abdelrahman Fathy', phone: '+201025344343', email: '', status: 'Active', hourlyRate: 300 },
  { id: 'inst-9', name: 'Eng. Abdelrahman Mohamed', phone: '', email: '', status: 'Active' },
  { id: 'inst-10', name: 'Eng. Abdelrahman Reda', phone: '+201272421743', email: '', status: 'Active', hourlyRate: 300 },
  { id: 'inst-11', name: 'Eng. Abdelrhman Tarek', phone: '+201554528272', email: '', status: 'Active', hourlyRate: 250 },
  ...
  { id: 'inst-16', name: 'Eng. Afaf Wael', phone: '+201066100020', email: '', status: 'Active', hourlyRate: 300 },
  { id: 'inst-17', name: 'Eng. Ahmed Adel', phone: '+201067403776', email: '', status: 'Active', hourlyRate: 300 },
  { id: 'inst-18', name: 'Eng. Ahmed Anwer', phone: '', email: '', status: 'Active' },
  { id: 'inst-19', name: 'Eng. Ahmed Deebs', phone: '+201004158038', email: '', status: 'Active', hourlyRate: 350 },
  ...
  { id: 'inst-23', name: 'Eng. Ahmed Hassan', phone: '+201124687570', email: '', status: 'Active', hourlyRate: 300 },
  { id: 'inst-24', name: 'Eng. Ahmed Hatem', phone: '+201024081432', email: '', status: 'Active', hourlyRate: 300 },
  ...
  { id: 'inst-29', name: 'Eng. Ali Mohamed', phone: '+201026761095', email: '', status: 'Active', hourlyRate: 350 },
  ...
  { id: 'inst-33', name: 'Eng. Arwaa Essam', phone: '+201553815261', email: '', status: 'Active', hourlyRate: 300 },
  { id: 'inst-34', name: 'Eng. Asmaa Ahmed', phone: '+201156286907', email: '', status: 'Active', hourlyRate: 500 },
  ...
  { id: 'inst-40', name: 'Eng. Eman Negm', phone: '+201029256644', email: '', status: 'Active', hourlyRate: 300 },
  ...
  { id: 'inst-45', name: 'Eng. Ghada Ahmed', phone: '+201003618299', email: '', status: 'Active', hourlyRate: 300 },
  { id: 'inst-46', name: 'Eng. Habiba Naeam', phone: '+201008860079', email: '', status: 'Active', hourlyRate: 300 },
  ...
  { id: 'inst-51', name: 'Eng. Hazem Sayed', phone: '+201284020017', email: '', status: 'Active', hourlyRate: 350 },
  { id: 'inst-52', name: 'Eng. Hossam el din', phone: '+201024325125', email: '', status: 'Active', hourlyRate: 350 },
  { id: 'inst-53', name: 'Eng. Hossam Fakher', phone: '', email: '', status: 'Active' },
  { id: 'inst-54', name: 'Eng. Ibrahem Mohamed', phone: '', email: '', status: 'Active' },
  { id: 'inst-55', name: 'Eng. Jana Hatem', phone: '+201149417447', email: '', status: 'Active', hourlyRate: 250 },
  { id: 'inst-56', name: 'Eng. Khaled Al-Difrawi', phone: '', email: '', status: 'Active' },
  { id: 'inst-57', name: 'Eng. Mahmoud Abd Rab-Elnaby', phone: '+201152317673', email: '', status: 'Active', hourlyRate: 250 },
  { id: 'inst-58', name: 'Eng. Mahmoud El-Shimey', phone: '+201007063123', email: '', status: 'Active', hourlyRate: 500 },
  { id: 'inst-59', name: 'Eng. Mahmoud Elhelaly', phone: '+201000767912', email: '', status: 'Active', hourlyRate: 250 },
  ...
  { id: 'inst-62', name: 'Eng. Maryam Mutawa', phone: '+201012360015', email: '', status: 'Active', hourlyRate: 450 },
  { id: 'inst-63', name: 'Eng. Mayar Sweilam', phone: '+201030685082', email: '', status: 'Active', hourlyRate: 300 },
  ...
  { id: 'inst-67', name: 'Eng. Mohamed Abdelazeem', phone: '+201000419359', email: '', status: 'Active', hourlyRate: 400 },
  { id: 'inst-68', name: 'Eng. Mohamed Abdelnaser', phone: '', email: '', status: 'Active' },
  { id: 'inst-69', name: 'Eng. Mohamed Abo Obida', phone: '+201026180568', email: '', status: 'Active', hourlyRate: 400 },
  ...
  { id: 'inst-76', name: 'Eng. Mohamed Mostafa', phone: '+201129255905', email: '', status: 'Active', hourlyRate: 350 },
  ...
  { id: 'inst-80', name: 'Eng. Mohamed Youssef', phone: '+201001653479', email: '', status: 'Active', hourlyRate: 380 },
  { id: 'inst-81', name: 'Eng. Mohammed Abdel-Mohsen', phone: '+201026952206', email: '', status: 'Active', hourlyRate: 350 },
  { id: 'inst-82', name: 'Eng. Mo\'men Yasser', phone: '+201559551582', email: '', status: 'Active', hourlyRate: 300 },
  { id: 'inst-83', name: 'Eng. Mostafa Zyada', phone: '+201149150615', email: '', status: 'Active', hourlyRate: 400 },
  ...
  { id: 'inst-87', name: 'Eng. Rawan Mahmoud', phone: '+201120769749', email: '', status: 'Active', hourlyRate: 250 },
  ...
  { id: 'inst-91', name: 'Eng. Sharliz Nabil', phone: '+201203983999', email: '', status: 'Active', hourlyRate: 300 },
  ...
  { id: 'inst-96', name: 'Eng. Yossef Mohamed', phone: '+201001653479', email: '', status: 'Active', hourlyRate: 350 },
  { id: 'inst-97', name: 'Eng. Youssef El Badri', phone: '+201154702011', email: '', status: 'Active', hourlyRate: 350 },
  { id: 'inst-98', name: 'Eng. Youssef El Khawanki', phone: '', email: '', status: 'Active' },
  { id: 'inst-99', name: 'Eng. Youssef Ismail', phone: '+201067267796', email: '', status: 'Active', hourlyRate: 140 },
  ...
  { id: 'inst-102', name: 'Eng. Mohamed Ashraf', phone: '+201142893381', email: '', status: 'Active', hourlyRate: 250 },
  { id: 'inst-103', name: 'Eng. Mohamed Abu Zaid', phone: '+201117039944', email: '', status: 'Active', hourlyRate: 280 }
];
